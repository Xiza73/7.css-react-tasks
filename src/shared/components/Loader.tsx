...
export const Loader: React.FC<LoaderProps> = ({ loading }) => {
  ...
  return (
    <div className="fixed z-[999] inset-0 text-text-100 bg-background-900 w-full h-screen">
      <div className="flex items-center justify-center overflow-hidden inset-0 bg-background-100 bg-opacity-50 w-full h-screen">
