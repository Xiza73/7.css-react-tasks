...
export const SnackbarProvider: React.FC<SnackbarProviderProps> = ({ children }) => {
  ...
  const openSnackbar = useCallback(({ type, message }: { type: Severity; message: string }) => {
    dispatch({
  ...
  const value = useMemo(() => ({ ...state, openSnackbar, closeSnackbar }), [state, openSnackbar, closeSnackbar]);
